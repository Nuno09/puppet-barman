...
class barman (
  ...
  Variant[Pattern['^[1-9][0-9]* (DAY|WEEK|MONTH)S?$','^false$'], Boolean] $last_backup_maximum_age             = $barman::settings::last_backup_maximum_age,
  ...
  Variant[Pattern['^get-wal$'], Undef] $recovery_options                                                       = $barman::settings::recovery_options,
  ...
  Variant[Pattern['^(off|link|copy)$'], Boolean] $reuse_backup                                                 = $barman::settings::reuse_backup,
  Variant[String, Undef] $slot_name                                                                            = $barman::settings::slot_name,
  Boolean $streaming_archiver                                                                                  = $barman::settings::streaming_archiver,
  Variant[Integer, Undef] $streaming_archiver_batch_size                                                       = $barman::settings::streaming_archiver_batch_size,
