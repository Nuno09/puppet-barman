...
class barman::settings (
  ...
  Variant[Pattern['^[0-9]+$'], Boolean] $basebackup_retry_sleep                                                = false,
  Variant[Pattern['^[0-9]+$'], Boolean] $basebackup_retry_times                                                = false,
  ...
  Variant[Pattern['^get-wal$'], Undef] $recovery_options                                                       = undef,
  ...
  Variant[Pattern['^(off|link|copy)$'], Boolean] $reuse_backup                                                 = false,
  Variant[String, Undef] $slot_name                                                                            = undef,
  Boolean $streaming_archiver                                                                                  = false,
  Variant[Integer, Undef] $streaming_archiver_batch_size                                                       = undef,
